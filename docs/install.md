...
```console
curl -LO https://github.com/carlbomsdata/winquick/releases/download/v0.4.6/winquick-0.4.6-darwin-arm64.tar.gz
curl -LO https://github.com/carlbomsdata/winquick/releases/download/v0.4.6/winquick-0.4.6-darwin-arm64.tar.gz.sha256
shasum -a 256 -c winquick-0.4.6-darwin-arm64.tar.gz.sha256
tar xzf winquick-0.4.6-darwin-arm64.tar.gz
sudo cp -R winquick-0.4.6-darwin-arm64/* /usr/local/
...
curl -LO https://github.com/carlbomsdata/winquick/releases/download/v0.4.6/winquick-0.4.6-linux-x86_64.tar.gz
tar xzf winquick-0.4.6-linux-x86_64.tar.gz
sudo cp -R winquick-0.4.6-linux-x86_64/* /usr/local/
winquick doctor
```
...
```console
curl.exe -LO https://github.com/carlbomsdata/winquick/releases/download/v0.4.6/winquick-0.4.6-windows-x86_64.zip
tar -xf winquick-0.4.6-windows-x86_64.zip
```
